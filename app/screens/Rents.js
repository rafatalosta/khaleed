...
var images = [
    { id: 1, src: require('../images/img3.png') },
    { id: 2, src: require('../images/img2.jpg') },
    { id: 3, src: require('../images/img4.jpg') },
    { id: 4, src: require('../images/imga.jpg') },
    ...
    render(){
      return(
        <View style={{flex:1, flexDirection: 'column'}}>
          ...
          <Text style={styles.flatListItem}>{this.props.item.machineDescription}</Text>
          <Text style={styles.flatListItem}>{this.props.item.price}</Text>

          </View>
        </View>
        <View style={{height: 1, backgroundColor: '#b3ffff'}}>
              ...
              {images.map((image, index) => {
                return (
                  <TouchableWithoutFeedback
                    ...
                    key={image.id}>
                    <Animated.View
                      style={{ height: SCREEN_HEIGHT - 550, width: SCREEN_WIDTH - 250, padding: 10,
                         paddingTop:20, borderWidth: 0.3, borderColor: '#cc0000' }}
                    >
                      <Image
